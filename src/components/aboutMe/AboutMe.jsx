  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 py-16 pb-0">
        ...
        <section className="mt-24 bg-gray-200 p-4">
          <div className="py-10 pt-0">
            <img className="exp" src="./projectImg/exp.jpg" alt="image" />
            ...
            <p className="max-w-screen-md mx-auto mt-2 leading-7 font-light md:text-lg md:leading-8">
              ...
              beyond. Each project has presented it&apos;s own set of challenges
              and opportunities for growth, allowing me to develop a well
              rounded skill and a keen understanding of what it takes to create
              exceptional user experience.
            </p>
          </div>
          <div>
            <img className="exp" src="./projectImg/res.jpg" alt="image" />
            <h1 className="font-regular text-2xl mt-3 md:text-4xl">
            ...
            <p className="max-w-screen-md mx-auto mt-2 leading-7 font-light md:text-lg md:leading-8">
              A responsive website not only enhances usability but also fosters
              greater user engagement by providing a seamless experience
              regardless of the devices being used. This is where I craft
              designs that truly leave an impact. I achieve this by employing
              fluid grids, flexible images, and media queries to ensure that
              every element of a website responds gracefully to different screen
              sizes.
            </p>
          </div>
          <div className="py-10 pb-0">
            <img className="exp" src="./projectImg/help.jpg" alt="image" />
